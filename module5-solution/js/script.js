...
document.addEventListener("DOMContentLoaded", function (event) {
  ...
  $ajaxUtils.sendGetRequest(allCategoriesUrl, buildAndShowHomeHTML, true); //STEP 1
});
...
function buildAndShowHomeHTML (categories){
  ...
  $ajaxUtils.sendGetRequest(homeHtmlUrl,
    function (homeHtmlUrl) {
      ...
      var homeHtmlToInsertIntoMainPage = insertProperty(homeHtmlUrl, "randomCategoryShortName", chosenCategoryShortName); //STEP 3
